...
namespace ca_test
{
    ...
    public class Borehole
    {
        ...
        public override string ToString() { return "{id = " + id.ToString() + ", name = " + name + ", depth = " + depth + ", company = " + company?.ToString() + 
    ...
    class DataBase
    {
        ...
        public readonly CompanyProvider CompanyProv;
        public readonly DepartmentProvider DepartmentProv;
        public readonly FieldProvider FieldProv;
        public readonly BoreholeProvider BoreholeProv;

        DataBase(string _connectingString)
        {
            Connection = new NpgsqlConnection(_connectingString);
            CompanyProv = new CompanyProvider(Connection);
            DepartmentProv = new DepartmentProvider(Connection);
            FieldProv = new FieldProvider(Connection);
            BoreholeProv = new BoreholeProvider(Connection);
        }
